...
@section('content')
    ...
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
            <h3 class="content-header-title mb-0 d-inline-block">@lang('admin.Reports') </h3>
            <div class="row breadcrumbs-top d-inline-block">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"> @lang('admin.Reports')
                        </li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            <form enctype="multipart/form-data" method="post"
                                  action="{{ action('Admin\ReportController@search') }}">
                                {{ csrf_field() }}
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <label class="col-md-4">@lang('admin.DataFrom')  </label>
                                                    <div class="col-md-8">
                                                        <input type='text' name="" class="form-control pickadate" placeholder="Basic Pick-a-date"/>
                                            ...
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <label class="col-md-4"> @lang('admin.DateTo') </label>
                                                    <div class="col-md-8">
                                                        <input type='text' name="" class="form-control pickadate" placeholder="Basic Pick-a-date"/>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <label class="col-md-4">@lang('admin.ReportType')  </label>
                                                    <div class="col-md-8">

                                                        <select name="done" class="select2  form-control">
                                                            <option> @lang('admin.Choose') </option>
                                                            <option value="1"> @lang('admin.MonthlyReport') </option>
                                                            <option value="2"> @lang('admin.HalfYearReport') </option>
                                                            <option value="3"> @lang('admin.AnnualReports') </option>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <label class="col-md-4"> @lang('admin.projectName') </label>
                                                    <div class="col-md-8">
                                                        <select name="beneficiaries" class="select2  form-control">
                                                            <option> @lang('admin.Choose') </option>
                                                            @foreach($allData as $beni)
                                                                <option value="{{ $beni->projectName }}">  {{ $beni->projectName }}</option>
                                                            @endforeach
