        ...
        <div class="content-header-right col-md-6 col-12">
            <div class="dropdown float-md-right">
                <div class="heading-elements">
                    <a href="{{ action('Admin\WorkRequestController@create') }}"
                            ...
                            <div class="card-body card-dashboard">
                                <table class="table table-striped table-bordered dataex-key-basic">
                                    ...
                                    <tr>
                                        ...
                                        <th> @lang('admin.workCat')  </th>
                                        <th> @lang('admin.requestNo')  </th>
                                        <th> @lang('admin.bidderNo')  </th>
                                    ...
                                    @foreach($allData as $data)
                                        <tr class="odd gradeX">
                                            ...
                                            <td> {{ $data->WorkCat->name }} </td>
                                            <td> {{ $data->requestNo }} </td>
                                            <td> {{ $data->bidderNo }} </td>

                                            <td>
                                                <a href="{{ action('Admin\WorkRequestController@edit' ,  $data->id) }}"
                                                   class="btn sbold blue ">
                                                    <i class="ft-edit"></i> </a>
                                                <a href="{{ action('Admin\WorkRequestController@delworkRequest' , $data->id) }}"
                                                   class="btn sbold red ">
