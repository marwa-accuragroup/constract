        ...
        <div class="content-header-right col-md-6 col-12">
            <div class="dropdown float-md-right">
                <div class="heading-elements">
                    <a href="{{ action('Admin\WorkCatController@create') }}"
                                ...
                                <table class="table table-striped table-bordered dataex-key-basic">
                                    ...
                                    @foreach($allData as $data)
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                <a href="{{ action('Admin\WorkCatController@edit' ,  $data->id) }}"
                                                   class="btn sbold blue ">
                                                    <i class="ft-edit"></i> </a>
                                                <a href="{{ action('Admin\WorkCatController@delworkCat' , $data->id) }}"
                                                   class="btn sbold red ">
