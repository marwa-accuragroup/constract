    ...
    <div class="portlet box  green ">
        ...
        <div class="portlet-body form">
            <form class="form-horizontal" role="form" enctype="multipart/form-data" method="post"
                  action="{{ action('Admin\PagesController@store') }}">
                {{ csrf_field() }}
                <div class="form-body">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="mt-radio-inline">
                                                        <label class="mt-radio">
                                                            <input type="radio" name="location"  value="1" > header
                                                            <span></span>
                                                        </label>
                                                        <label class="mt-radio">
                                                            <input type="radio" name="location"  value="2" > Footer
                                                            <span></span>
                                                        </label>
                                                        <label class="mt-radio">
                                                            <input type="radio" name="location"  value="3" > Both
                                                            <span></span>
                                                        </label>
                                                    </div>
                                                </div>
