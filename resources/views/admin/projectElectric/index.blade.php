            ...
            <div class="row breadcrumbs-top d-inline-block">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"> @lang('admin.ProjectElectrical')
                        </li>
                    </ol>
                </div>
            </div>
        ...
        <div class="content-header-right col-md-6 col-12">
            <div class="dropdown float-md-right">
                <div class="heading-elements">
                    <a href="{{ action('Admin\ProjectElectricalController@create') }}"
                                ...
                                <table class="table table-striped table-bordered dataex-key-basic">
                                    ...
                                    @foreach($allData as $data)
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                <a href="{{ action('Admin\ProjectElectricalController@edit' ,  $data->id) }}"
