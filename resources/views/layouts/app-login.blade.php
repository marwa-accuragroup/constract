...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="{{ URL ::to ('assets/admin/app-assets/vendors/css/forms/icheck/icheck.css')}}">
    <link rel="stylesheet" type="text/css"
          href="{{ URL ::to ('assets/admin/app-assets/vendors/css/forms/icheck/custom.css')}}">
    <!-- END VENDOR CSS-->
    <!-- BEGIN MODERN CSS-->
    ...
    <link rel="stylesheet" type="text/css"
          href="{{ URL ::to ('assets/admin/app-assets/css-rtl/core/menu/menu-types/vertical-menu.css')}}">
    <link rel="stylesheet" type="text/css"
          href="{{ URL ::to ('assets/admin/app-assets/css-rtl/core/colors/palette-gradient.css')}}">
    <link rel="stylesheet" type="text/css"
          href="{{ URL ::to ('assets/admin/app-assets/css-rtl/pages/login-register.css')}}">
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
                                ...
                                <div class="card-title text-center">
                                    <div class="p-1">
                                        <img style="max-width: 350px;"
                                             src="{{ URL ::to ('assets/admin/app-assets/images/logo/logo-dark.png')}}"
                                             alt="branding logo">
                                    </div>
                                </div>
...
<script src="{{ URL ::to ('assets/admin/app-assets/vendors/js/forms/icheck/icheck.min.js')}}"
...
<!-- END MODERN JS-->
<!-- BEGIN PAGE LEVEL JS-->
<script src="{{ URL ::to ('assets/admin/app-assets/js/scripts/forms/form-login-register.js')}}"
        type="text/javascript"></script>
<!-- END PAGE LEVEL JS-->
</body>
</html>